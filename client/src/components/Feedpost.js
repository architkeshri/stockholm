...
const Feedpost = ({feeds, visible, setVisible}) => {
        ...
        return (
            <Card className= "cardi" style={{ width: '100%', margin: '3% 0', borderRadius: '20px', transitionDuration: '0.5s', cursor: 'pointer' }}>
                <Card.Body>
                    ...
                    <div style={{display: 'flex'}}><h4>{item.userInfo.name}</h4><span style={{position: 'absolute', marginLeft: '75%'}}><img src="https://img.icons8.com/material-two-tone/24/000000/menu-2.png"/></span></div>
